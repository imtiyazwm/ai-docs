...
import ThreePillars from './assets/img/1-ThreePillar.png'
import DesignSystem from './assets/img/2-DesignSystemApp.png'
import DesignToCode from './assets/img/5-design-to-code.png'
import AIRA from './assets/img/3-AIRA.png'
import ReactSupport from './assets/img/4-ReactApp.png'
import AutoLayoutContainers from './assets/img/6-Autolayout.png'
import ProductEcosystem from './assets/img/7-Ecosystem.png'

<Common.WaveMakerAIHeading scale={2} />
...
![Three Pillars](./assets/img/1-ThreePillar.png)
...
### Design to Code ([Design to code](../../design-system/figma-design-to-code-plugin/working-with-design-to-code-plugin.md))

Design to Code enables direct conversion of supported design systems into working applications. Layout, styling, and components are generated automatically, allowing teams to move from design to implementation with minimal manual effort.
...
![](./assets/img/2-DesignSystemApp.png)

---

## Design to Code: Converts designs into production ready Code

[Design to Code](../../design-system/figma-design-to-code-plugin/working-with-design-to-code-plugin.md) is a figma plugin that converts supported designs into WaveMaker applications using a design-first approach.
...
Design to Code currently supports designs built using the WaveMaker UI Kit and Material 3, with plans to expand support to additional design systems. Generated projects can also be imported into WaveMaker Enterprise environments.

![Design to Code](./assets/img/5-design-to-code.png)
...
## ![ReactApps](./assets/img/4-ReactApp.png)
...
![AutoLayout](./assets/img/6-Autolayout.png)
...
![ProductEcosystem](./assets/img/7-Ecosystem.png)
